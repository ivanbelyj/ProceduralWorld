...
public class ChunkWorld : MonoBehaviour
{
    ...
    // public async Task AddPointOfPresenceAsync(ChunkPosition chunkPos) {
    ...
    //                 await GenerateAndCreateChunkGO(pos);
    //             }
    ...
    //                 && pointsOfPresence.All(p => Vector3.Distance(new Vector3(p.X, 0, p.Z),
